...
[["second-item5-nonum-nopl", 5], aj, {s: {html: "<p>Kontext: V současnosti je známo alespoň 300 druhů chobotnic. Dva rybáři (A a B) si povídají o chobotnicích a v reakci na to, co řekl A, B odpovídá:</p><p>Věta: <b>B: Pokud jde o chobotnici obecnou, tak tradičně naši rybáři tuto chobotnici loví. </b></p>"}}],
[["second-item5-nonum-pl", 5], aj, {s: {html: "<p>Kontext: V současnosti je známo alespoň 300 druhů chobotnic. Dva rybáři (A a B) si povídají o chobotnicích a v reakci na to, co řekl A, B odpovídá:</p><p>Věta: <b>B: Pokud jde o chobotnici pacifickou a chobotnici obecnou, tak tradičně naši rybáři tyto chobotnice loví.</b></p>"}}],

[["second-item6-nonum-nopl", 6], aj, {s: {html: "<p>Kontext: v současnosti je známo mnoho druhů ústřic. Dva prodavači v rybárně (A a B) si povídají o ústřicích a v reakci na to, co řekl A, B odpovídá: </p><p>Věta: <b>B: Pokud jde o ústřici jedlou, v naší zemi tuto ústřici chováme.</b></p>"}}],
[["second-item6-nonum-pl", 6], aj, {s: {html: "<p>Kontext: v současnosti je známo mnoho druhů ústřic. Dva prodavači v rybárně (A a B) si povídají o ústřicích a v reakci na to, co řekl A, B odpovídá:</p><p>Věta: <b>B: Pokud jde o ústřici jedlou a ústřici obrovskou, v naší zemi tyto ústřice chováme.</b></p>"}}],

[["second-item7-nonum-nopl", 7], aj, {s: {html: "<p>Kontext: v současnosti je známo několik druhů kaktusů. Dva zahradníci (A a B) si povídají o kaktusech a v reakci na to, co řekl A, B odpovídá:</p><p>Věta: <b>B: Pokud jde o kaktus hvězdnatý, v naší zahradě tento kaktus pěstujeme.  </b></p>"}}],
[["second-item7-nonum-pl", 7], aj, {s: {html: "<p>Kontext: v současnosti je známo několik druhů kaktusů. Dva zahradníci (A a B) si povídají o kaktusech a v reakci na to, co řekl A, B odpovídá:</p><p>Věta: <b>B: Pokud jde o kaktus hvězdnatý a kaktus sloupcovitý, v naší zahradě tyto kaktusy pěstujeme.</b></p>"}}],

[["second-item8-nonum-nopl", 8], aj, {s: {html: "<p> Kontext: Je známo několik druhů kávy. Dva baristé (A a B) si povídají o kávě a v reakci na to, co řekl A, B odpovídá:</p><p>Věta: <b>B: Pokud jde o kávu robustu, v přípravném kurzu jsme tuto kávu studovali.</b></p>"}}],
[["second-item8-nonum-pl", 8], aj, {s: {html: "<p> Kontext: Je známo několik druhů kávy. Dva baristé (A a B) si povídají o kávě a v reakci na to, co řekl A, B odpovídá:</p><p>Věta: <b>B: Pokud jde o kávu robustu a kávu arabiku, v přípravném kurzu jsme tyto kávy studovali.</b></p>"}}],
